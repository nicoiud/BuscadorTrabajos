...
async def semantic_search_jobs(
    ...
    extra_filters = build_job_filters(body.languages, body.onsite_location)
    items = await semantic_search(db, query_embedding, limit=body.limit, extra_filters=extra_filters)
